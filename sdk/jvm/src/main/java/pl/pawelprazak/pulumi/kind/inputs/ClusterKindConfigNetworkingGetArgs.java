...
public final class ClusterKindConfigNetworkingGetArgs extends io.pulumi.resources.ResourceArgs {
    ...
    public static Builder builder(ClusterKindConfigNetworkingGetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ClusterKindConfigNetworkingGetArgs defaults) {
        ...
        public ClusterKindConfigNetworkingGetArgs build() {
            return new ClusterKindConfigNetworkingGetArgs(apiServerAddress, apiServerPort, disableDefaultCni, ipFamily, kubeProxyMode, podSubnet, serviceSubnet);
        }
    }
}
